...
<span class="cstat-no" title="statement not covered" >      log.verbose('getNpmInfo error', body.error);</span>
<span class="cstat-no" title="statement not covered" >      return Promise.reject(new Error(body.error));</span>
    }
&nbsp;
...
function getLatestVersion(npm) {
  return getNpmInfo(npm).then((data) =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!data['dist-tags'] || !data['dist-tags'].latest) {
<span class="cstat-no" title="statement not covered" >      log.error('没有 latest 版本号', data);</span>
<span class="cstat-no" title="statement not covered" >      return Promise.reject(new Error('Error: 没有 latest 版本号'));</span>
    }
&nbsp;
...
&nbsp;
function getNpmRegistry(npmName = <span class="branch-0 cbranch-no" title="branch not covered" >'')</span> {
...
&nbsp;
function getUnpkgHost(npmName = <span class="branch-0 cbranch-no" title="branch not covered" >'')</span> {
...
&nbsp;
function getNpmClient(npmName = <span class="branch-0 cbranch-no" title="branch not covered" >'')</span> {
...
<span class="cstat-no" title="statement not covered" >    log.verbose('checkAliInternal error: ', err);</span>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Wed Apr 03 2019 12:54:53 GMT+0800 (CST)
</div>
</div>
